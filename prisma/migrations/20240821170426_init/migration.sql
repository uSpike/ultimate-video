...
CREATE TABLE "GamePointAction" (
    ...
    CONSTRAINT "GamePointAction_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "GamePointActionType" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
-- CreateTable
CREATE TABLE "GamePointActionType" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "type" TEXT NOT NULL,
    "description" TEXT NOT NULL,
    "requirePrimaryPlayer" TEXT NOT NULL,
    "primaryPlayerLabel" TEXT NOT NULL DEFAULT 'Primary',
    "requireSecondaryPlayer" TEXT NOT NULL DEFAULT 'false',
    "secondaryPlayerLabel" TEXT NOT NULL DEFAULT 'Secondary',
    "requireState" TEXT NOT NULL DEFAULT 'any'
);

-- CreateTable
CREATE TABLE "GamePointActionNoteType" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "name" TEXT NOT NULL,
    "description" TEXT,
    "typeId" INTEGER NOT NULL,
    CONSTRAINT "GamePointActionNoteType_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "GamePointActionType" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateTable
CREATE TABLE "_GamePointActionToGamePointActionNoteType" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,
    CONSTRAINT "_GamePointActionToGamePointActionNoteType_A_fkey" FOREIGN KEY ("A") REFERENCES "GamePointAction" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_GamePointActionToGamePointActionNoteType_B_fkey" FOREIGN KEY ("B") REFERENCES "GamePointActionNoteType" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "GamePointActionType_type_key" ON "GamePointActionType"("type");

-- CreateIndex
CREATE UNIQUE INDEX "GamePointActionNoteType_name_typeId_key" ON "GamePointActionNoteType"("name", "typeId");
...
-- CreateIndex
CREATE UNIQUE INDEX "_GamePointActionToGamePointActionNoteType_AB_unique" ON "_GamePointActionToGamePointActionNoteType"("A", "B");

-- CreateIndex
CREATE INDEX "_GamePointActionToGamePointActionNoteType_B_index" ON "_GamePointActionToGamePointActionNoteType"("B");
